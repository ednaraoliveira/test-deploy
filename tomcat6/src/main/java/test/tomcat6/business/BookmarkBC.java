...
import test.tomcat6.config.PropertiesConfig;
import test.tomcat6.domain.Bookmark;
import test.tomcat6.persistence.BookmarkDAO;
import test.tomcat6.security.Login;
